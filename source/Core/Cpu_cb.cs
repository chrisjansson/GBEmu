...
namespace Core
{
    public partial class Cpu
    {
        private readonly Dictionary<byte, InstructionMetaData> _cbInstructions = new Dictionary<byte, InstructionMetaData>
        {
            ...
            {0x46, new InstructionMetaData(2, 3, "BIT 0, (HL)")},
            ...
            {0x4E, new InstructionMetaData(2, 3, "BIT 1, (HL)")},
            ...
            {0x56, new InstructionMetaData(2, 3, "BIT 2, (HL)")},
            ...
            {0x5E, new InstructionMetaData(2, 3, "BIT 3, (HL)")},
            ...
            {0x66, new InstructionMetaData(2, 3, "BIT 4, (HL)")},
            ...
            {0x6E, new InstructionMetaData(2, 3, "BIT 5, (HL)")},
            ...
            {0x76, new InstructionMetaData(2, 3, "BIT 6, (HL)")},
            ...
            {0x7E, new InstructionMetaData(2, 3, "BIT 7, (HL)")},
            ...
            {0x8B, new InstructionMetaData(2, 2, "RES 1, E")},
            {0x8C, new InstructionMetaData(2, 2, "RES 1, H")},
            {0x8D, new InstructionMetaData(2, 2, "RES 1, L")},
            ...
            {0x93, new InstructionMetaData(2, 2, "RES 2, E")},
            {0x94, new InstructionMetaData(2, 2, "RES 2, H")},
            {0x95, new InstructionMetaData(2, 2, "RES 2, L")},
            ...
            {0x9B, new InstructionMetaData(2, 2, "RES 3, E")},
            {0x9C, new InstructionMetaData(2, 2, "RES 3, H")},
            {0x9D, new InstructionMetaData(2, 2, "RES 3, L")},
            ...
            {0xA3, new InstructionMetaData(2, 2, "RES 4, E")},
            {0xA4, new InstructionMetaData(2, 2, "RES 4, H")},
            {0xA5, new InstructionMetaData(2, 2, "RES 4, L")},
            ...
            {0xAB, new InstructionMetaData(2, 2, "RES 5, E")},
            {0xAC, new InstructionMetaData(2, 2, "RES 5, H")},
            {0xAD, new InstructionMetaData(2, 2, "RES 5, L")},
            ...
            {0xB3, new InstructionMetaData(2, 2, "RES 6, E")},
            {0xB4, new InstructionMetaData(2, 2, "RES 6, H")},
            {0xB5, new InstructionMetaData(2, 2, "RES 6, L")},
            ...
            {0xBB, new InstructionMetaData(2, 2, "RES 7, E")},
            {0xBC, new InstructionMetaData(2, 2, "RES 7, H")},
            ...
            {0xC9, new InstructionMetaData(2, 2, "SET 1, C")},
            {0xCA, new InstructionMetaData(2, 2, "SET 1, D")},
            {0xCB, new InstructionMetaData(2, 2, "SET 1, E")},
            {0xCC, new InstructionMetaData(2, 2, "SET 1, H")},
            {0xCD, new InstructionMetaData(2, 2, "SET 1, L")},
            ...
            {0xD1, new InstructionMetaData(2, 2, "SET 2, C")},
            {0xD2, new InstructionMetaData(2, 2, "SET 2, D")},
            {0xD3, new InstructionMetaData(2, 2, "SET 2, E")},
            {0xD4, new InstructionMetaData(2, 2, "SET 2, H")},
            {0xD5, new InstructionMetaData(2, 2, "SET 2, L")},
            ...
            {0xD9, new InstructionMetaData(2, 2, "SET 3, C")},
            {0xDA, new InstructionMetaData(2, 2, "SET 3, D")},
            {0xDB, new InstructionMetaData(2, 2, "SET 3, E")},
            {0xDC, new InstructionMetaData(2, 2, "SET 3, H")},
            {0xDD, new InstructionMetaData(2, 2, "SET 3, L")},
            ...
            {0xE1, new InstructionMetaData(2, 2, "SET 4, C")},
            {0xE2, new InstructionMetaData(2, 2, "SET 4, D")},
            {0xE3, new InstructionMetaData(2, 2, "SET 4, E")},
            {0xE4, new InstructionMetaData(2, 2, "SET 4, H")},
            {0xE5, new InstructionMetaData(2, 2, "SET 4, L")},
            ...
            {0xE9, new InstructionMetaData(2, 2, "SET 5, C")},
            {0xEA, new InstructionMetaData(2, 2, "SET 5, D")},
            {0xEB, new InstructionMetaData(2, 2, "SET 5, E")},
            {0xEC, new InstructionMetaData(2, 2, "SET 5, H")},
            {0xED, new InstructionMetaData(2, 2, "SET 5, L")},
            ...
            {0xF1, new InstructionMetaData(2, 2, "SET 6, C")},
            {0xF2, new InstructionMetaData(2, 2, "SET 6, D")},
            {0xF3, new InstructionMetaData(2, 2, "SET 6, E")},
            {0xF4, new InstructionMetaData(2, 2, "SET 6, H")},
            {0xF5, new InstructionMetaData(2, 2, "SET 6, L")},
            ...
            {0xF9, new InstructionMetaData(2, 2, "SET 7, C")},
            {0xFA, new InstructionMetaData(2, 2, "SET 7, D")},
            {0xFB, new InstructionMetaData(2, 2, "SET 7, E")},
            {0xFC, new InstructionMetaData(2, 2, "SET 7, H")},
            {0xFD, new InstructionMetaData(2, 2, "SET 7, L")},
